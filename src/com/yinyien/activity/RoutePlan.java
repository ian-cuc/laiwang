...
public class RoutePlan extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        if (app.mBMapManager == null) {
             ...
             */
            app.mBMapManager.init(new laiwangApplication.MyGeneralListener());
        }
...
//					ArrayList<MKCityListInfo> enCities = res.getAddrResult().mEndCityList;
			    ...
			    //清除其他图层
//hahahahaah			    mMapView.getOverlays().clear();
			    //添加路线图层
...
//					ArrayList<MKCityListInfo> enCities = res.getAddrResult().mEndCityList;
			  ...
			  //清除其他图层
//hahahahahah			    mMapView.getOverlays().clear();
			  //添加路线图层
...
//					ArrayList<MKCityListInfo> enCities = res.getAddrResult().mEndCityList;
				...
				{
//hahahahaha			    mMapView.getOverlays().clear();
				}
...
//		stNode.name = editSt.getText().toString();
		double Latitude_start =   FragmentOne.mylocation.getLatitude();
		double longitude_start =  FragmentOne.mylocation.getLongitude();
		stNode.pt = new GeoPoint((int) (Latitude_start * 1E6),  
...
//		enNode.name = editEn.getText().toString();
         ...
         editEn.setText(addressName);
         double Latitude_end = Double.parseDouble(Latitude);  
         double longitude_end = Double.parseDouble(longitude);  
         //终点的经纬度
         enNode.pt = new GeoPoint((int) (Latitude_end * 1E6), (int) (longitude_end * 1E6)); 
