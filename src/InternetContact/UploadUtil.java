...
public class UploadUtil {
			...
			*/
			...
			private int toUploadFile(File file, String fileKey, String RequestURL,
			Map<String, String> param) {
			String result = null;
			requestTime= 0;
...
//	hahahahaah		onUploadProcessListener.initUpload((int)file.length());
...
//	hahahah		onUploadProcessListener.onUploadProcess(curLen);
			}
			is.close();
